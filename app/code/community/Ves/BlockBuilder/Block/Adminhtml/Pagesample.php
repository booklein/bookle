 ...
 * @author    
 */
class Ves_BlockBuilder_Block_Adminhtml_Pagesample extends Mage_Adminhtml_Block_Widget_Form_Container {
    public function __construct() {
        ...
        $this->setTemplate('ves_blockbuilder/pagesample.phtml');
    }
    ...
    public function getDataSampleLink($profile = "", $sub_folder = "") {
        return $this->getUrl('*/adminhtml_page/importCsv', array('profile'=>$profile, 'subfolder'=>$sub_folder));
    }

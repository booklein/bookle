...
-------------------------------------------------------------------------*/
class Ves_BlockBuilder_Adminhtml_PageController extends Mage_Adminhtml_Controller_Action {
        ...
        if ($post_data) {
            ...
            try {
                ...
                if ($this->getRequest()->getParam("duplicate")) {
                    ...
                    $data = array();
                    $page = Mage::getModel("cms/page")->load($post_data['alias'], "identifier");
     ...
     */
     public function deleteAction() {
        ...
        if( $this->getRequest()->getParam('id') > 0 ) {
            try {
                $model = Mage::getModel('ves_blockbuilder/banner');

		...
		if($banners){
			...
			if(isset($banners['slide'])) {
				...
				if( isset($slider_data['slider_usevideo']) && ($slider_data['slider_usevideo'] == 'youtube' || $slider_data['slider_usevideo'] == 'vimeo' ) && $slider_data['slider_videoid'] ) {
					...
					$html .= '<iframe src="'.$vurl.'?title=0&amp;byline=0&amp;portrait=0;api=1" width="100%" height="100%" frameborder="0" webkitAllowFullScreen="webkitAllowFullScreen" mozallowfullscreen="mozallowfullscreen" allowFullScreen="allowFullScreen"></iframe>';
				}

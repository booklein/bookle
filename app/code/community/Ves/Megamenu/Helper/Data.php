        ...
        foreach($collection as $option) {
            ...
            if($type->getData( "name" )) {
                if($select) {
                    ...
                    $html .= '<option value="'.$option->getId().'" '.$selectOption.'>(ID: '.$type->getId().")".$type->getData( "name" ).'</option>';
                } else {
                    $html .= '<option value="'.$option->getId().'">(ID: '.$type->getId().")".$type->getData( "name" ).'</option>';
                }
            }
        }
        return $html;
